...
const Cart = {
  ...
  list(lang){
    return Object.entries(this.items).map(([id,qty])=>{
      ...
      return { id:+id, name:d.name[lang], qty, price:d.price, sum:d.price*qty };
    });
  },
