...
const I18N = {
  ua: {
    ...
    hours_label: "Години роботи:", hours_time: "🕘 14:30 – 22:30",
    ...
    quick_order_hint: "Вкажіть лише Telegram — з вами зв'яжуться для уточнення деталей",
    quick_success_title: "✅ Дякуємо за замовлення!",
    quick_success_text: "З вами зв'яжуться в Telegram.",
  ...
  ru: {
    ...
    hours_label: "Часы работы:", hours_time: "🕘 14:30 – 22:30",
    sub_new: "Новинки", badge_new: "Новинка",
    ...
    quick_order_hint: "Укажите только Telegram — с вами свяжутся для уточнения деталей",
    quick_success_title: "✅ Спасибо за заказ!",
    quick_success_text: "С вами свяжутся по Telegram.",
  ...
  en: {
    ...
    hours_label: "Working hours:", hours_time: "🕘 2:30 – 10:30 PM",
    ...
    quick_order_hint: "Enter only your Telegram — we'll contact you for the details",
    quick_success_title: "✅ Thank you for your order!",
    quick_success_text: "We'll contact you via Telegram.",
  ...
  vn: {
    ...
    hours_label: "Giờ làm việc:", hours_time: "🕘 14h30 – 22h30",
    ...
    quick_order_hint: "Chỉ cần nhập Telegram — chúng tôi sẽ liên hệ để biết thêm chi tiết",
    quick_success_title: "✅ Cảm ơn bạn đã đặt hàng!",
    quick_success_text: "Chúng tôi sẽ liên hệ qua Telegram.",
